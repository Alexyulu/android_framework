...
public class CircleTextProgressbar extends AppCompatTextView{
    ...
    public CircleTextProgressbar setCustomTextColor(@ColorInt int color) {
        super.setTextColor(color);
        return this;
    }

    public CircleTextProgressbar setCustomText(CharSequence text) {
        super.setText(text);
        return this;
    }

    public CircleTextProgressbar setOnCustomClickListener(@Nullable View.OnClickListener listener) {
     ...
     */
    public CircleTextProgressbar setOutLineColor(@ColorInt int outLineColor) {
     ...
     */
    public CircleTextProgressbar setOutLineWidth(@ColorInt int outLineWidth) {
     ...
     */
    public CircleTextProgressbar setInCircleColor(@ColorInt int inCircleColor) {
     ...
     */
    public CircleTextProgressbar setProgressColor(@ColorInt int progressLineColor) {
     ...
     */
    public CircleTextProgressbar setProgressLineWidth(int progressLineWidth) {
     ...
     * @param progress 进度。
     */
    public CircleTextProgressbar setProgress(int progress) {
     ...
     * @param timeMillis 毫秒。
     */
    public CircleTextProgressbar setTimeMillis(long timeMillis) {
     ...
     */
    public CircleTextProgressbar setProgressType(ProgressType progressType) {
     ...
     */
    public CircleTextProgressbar setCountdownProgressListener(int what, OnCountdownProgressListener mCountdownProgressListener) {
     ...
     * 开始。
     */
    public CircleTextProgressbar start() {
        stop();
